...
public class TestNull extends BaseTest {
    ...
    public void testNullInteger() throws IOException, RecognitionException, LexerException, ParserException, SymbolTableException, InterruptedException {
        ...
        sb.append("(PROGRAM (DECL_OUTSTREAM const out<std_output()> std_output()) (PROCEDURE_DECL main<integer> (BLOCK (VAR_DECL i<integer> (EXPR<integer> 0<integer>)) (VAR_DECL j<integer> (EXPR<integer> (+<integer> 2<integer> 0<integer:integer>))) (PRINT (EXPR<integer> i<integer>)) (PRINT (EXPR<integer> j<integer>)) (return<integer> (EXPR<integer> 0<integer>)))))");
